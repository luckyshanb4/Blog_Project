...
app.post('/compose',function(req,res){
  ...
  let currentTitle=lodash.lowerCase(req.body.postTitle);
...
app.get('/post/:postId',function(req,res){
  let searchPostId=req.params.postId;

  
  Post.findOne({_id:searchPostId},function(err,post){
    if(!err){
      if(post){
  ...
  //   if(searchPostName===currentTitle){
  //     console.log("Match Found!");
